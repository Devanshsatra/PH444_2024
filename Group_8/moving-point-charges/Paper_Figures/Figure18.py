...
charges = (OrbittingCharge(pos_charge=True, phase=0, max_speed=0.5*c),OrbittingCharge(pos_charge=False, phase=np.pi/12, max_speed=0.5*c))
t = 0
...
# %% Animation
charges = (OrbittingCharge(pos_charge=True, phase=0, max_speed=0.5*c, start_zero=True),OrbittingCharge(pos_charge=False, phase=np.pi/12, max_speed=0.5*c, start_zero=True))
