# %% xz Accelerating charge with time Ex, Ez, By
import numpy as np
...
final_v = 0.99*c  # final velocity at lim
x_stop = 30e-9
acceleration = final_v**2*0.5/x_stop
t_end = (2*x_stop/acceleration)**0.5
charges = LinearAcceleratingCharge(
    pos_charge=True, acceleration=acceleration, stop_t=t_end)
